...
export function AISearchTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        position === "float" && [
          "inset-e-[calc(--spacing(4)+var(--removed-body-scroll-bar-size,0px))] fixed bottom-4 z-20 w-24 gap-3 shadow-lg transition-[translate,opacity]",
      ...
      {actualOpen && (
        <div
          className={cn(
            ...
            "lg:fixed lg:inset-y-0 lg:end-0 lg:h-dvh lg:border-s lg:shadow-xl",
            open
